...
from app.modules.assistantv2 import parsing, registry, resolvers
...
def get_balance(db, actor, params: dict):
    ...
    # Plusieurs caisses : on s'en tient au solde net par caisse pour rester
    # lisible dans une reponse de chat. Le detail encaisse/depense reste
    # disponible caisse par caisse via une reference explicite.
    rows = []
    lines = []
...
def list_transactions(db, actor, params: dict):
    ...
    if ref:
        ...
        try:
            ...
            business = None  # activite inconnue : on ignore le filtre plutot que d'echouer
...
def get_period_summary(db, actor, params: dict):
    ...
    if ref:
        ...
        try:
            ...
            businesses = None  # activite inconnue : on retombe sur toutes les activites accessibles
