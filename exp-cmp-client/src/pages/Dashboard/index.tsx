...
export default function Dashboard() {
  ...
  if (accountsLoading || kpisLoading) return <div className="grid min-h-64 place-items-center"><div className="h-8 w-8 animate-spin rounded-full border-2 border-[var(--color-primary)] border-t-transparent" /></div>;
